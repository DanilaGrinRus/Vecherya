...
function render(cardsRaw, mapping) {
  ...
  for (let i = 0; i < filtered.length; i++) {
    ...
    const srcSmall = (fileObj && typeof fileObj === "object") ? fileObj.s : fileObj;
    const srcLarge = (fileObj && typeof fileObj === "object") ? fileObj.l : fileObj;
    ...
    const imgHtml = srcSmall
      ? `<img class="card-item__img"
              ...
              srcset="assets/cards/${srcSmall} 300w, assets/cards/${(srcLarge || srcSmall)} 600w"
